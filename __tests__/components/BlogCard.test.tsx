...
describe("BlogCard Component", () => {
    ...
    it("renders the BlogCard with correct content", () => {
        ...
        expect(image).toHaveAttribute("src", expect.stringContaining("/_next/image?url=%2Fmocked-image-url.jpg"));

        // Check if the description is rendered correctly
        const description = screen.getByText("This is a short description of the blog post.");

  ...
  return (
    <>
      ...
      >
        <main className={`p-6`}>
          <NavBar />
          <div className="flex items-center justify-center mt-20"><Banner /></div>
          <div className="flex items-center justify-center p-4 mt-20"><About /></div>
          ...
          <div className={`flex flex-row items-end justify-end md:-mr-36 sm:-mr-32 mt-10`}><ShowMoreButton href={"/themen"} label={"Mehr"} /></div>
          <div className={` flex flex-row justify-center mt-10`}><NewsLetter /></div>
          <Footer />
        </main>
      </div>
    </>

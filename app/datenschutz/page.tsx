        ...
        <div className="relative bg-cover bg-no-repeat max-h-full max-w-[1440px]">
            ...
            <main className="p-6 relative z-10">
                ...
                <div className="bg-white rounded-xl shadow-xl p-5 mt-20">
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">1. Verantwortlicher für die Datenverarbeitung</h2>
                    <p className='text-md'>
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">2. Ihre Rechte</h2>
                    <p className='text-md'>
                        Sie haben gegenüber uns folgende Rechte hinsichtlich der Sie betreffenden personenbezogenen Daten:
                    </p>
                    <h3 className="text-lg text-orange-400 font-bold mt-4">2.1 Allgemeine Rechte</h3>
                    <p className='text-sm'>
                        Sie haben ein Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung, Widerspruch gegen die Verarbeitung und auf Datenübertragbarkeit. Soweit eine Verarbeitung auf Ihrer Einwilligung beruht, haben Sie das Recht, diese uns gegenüber mit Wirkung für die Zukunft zu widerrufen.
                    </p>

                    <h3 className="text-lg text-orange-400 font-bold mt-4">
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">
                    ...
                    <p className="text-md">
                        Diese Website verwendet Social-Plugins des/der Facebook, Instagram und YouTube.
                        - Facebook (Betreiber: Facebook Inc., 1601 S. California Ave, Palo Alto, CA 94304, USA)
                        - Instagram (Betreiber: Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland)
                    ...
                    <p className='text-md'>
                        ...
                        Facebook: <Link
                            href="https://cloud.hamburg.global/index.php/apps/forms/s/j7kFXRTtALSMM4DfEEJt6Faa"
                            target="_blank" rel="noopener noreferrer" className="text-orange-300 font-semibold"
                        >https://www.facebook.com/policy/</Link><br />
                        Instagram: <Link
                            href="https://cloud.hamburg.global/index.php/apps/forms/s/j7kFXRTtALSMM4DfEEJt6Faa"
                            target="_blank" rel="noopener noreferrer" className="text-orange-300 font-semibold"
                        >https://privacycenter.instagram.com/policy/?entry_point=ig_help_center_data_policy_redirect</Link><br />
                        Youtube: <Link
                            href="https://cloud.hamburg.global/index.php/apps/forms/s/j7kFXRTtALSMM4DfEEJt6Faa"
                            target="_blank" rel="noopener noreferrer" className="text-orange-300 font-semibold"
                        >https://policies.google.com/privacy?hl=de&gl=de</Link>
                    </p>
                    <h2 className="text-xl text-orange-600 font-bold mt-6">8. YouTube</h2>
                    <p className="text-md">
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">9. Einsatz von Cookies</h2>
                    <p className="text-md">
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">10. Webseitenanalyse</h2>
                    <p className='text-md'>
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">11. Datenübermittlung</h2>
                    <p className='text-md'>
                    ...
                    <h2 className="text-xl text-orange-600 font-bold mt-6">12. Datensicherheit</h2>
                    <p className='text-md'>

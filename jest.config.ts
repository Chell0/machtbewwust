...
const config: Config = {
	...
	setupFilesAfterEnv: [
		...
		"<rootDir>/jest.globalMocks.ts",
	], // Include the global mocks
	...
	modulePathIgnorePatterns: ["<rootDir>/node_modules/", "<rootDir>/.next/"], // Ignore unnecessary paths
	maxWorkers: "50%", // Optimize parallel test execution
	testTimeout: 10000, // Set global timeout for tests
};
